...
object App extends App {
  ...
  ca.repartition(10).write.format("org.apache.spark.sql.execution.datasources.v2.json.JsonDataSourceV2").save("gs://ac-rftexchange-qa-project-dataproc-staging/Output/customer.json")
